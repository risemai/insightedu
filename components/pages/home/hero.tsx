      ...
      <div className='container mx-auto'>
        <div className='relative rounded-[2.5rem] overflow-hidden bg-slate-900 min-h-125 flex items-center justify-center p-8 md:p-16'>
          ...
          <div className='relative z-10 text-center max-w-4xl mx-auto'>
            ...
            <button className='bg-blue-600 text-white px-10 py-5 rounded-full font-extrabold text-lg hover:bg-blue-500 transition-all transform hover:scale-105 active:scale-95 shadow-xl shadow-blue-600/30'>
              Explore More
            </button>
          </div>

          {/* Abstract Shapes */}
          <div className='absolute -bottom-16 -left-16 w-64 h-64 bg-blue-600/20 rounded-full blur-3xl'></div>
